...
#undef _CONVERT
  ...
  /**
   * @brief Get the local IP address of the interface that routes to the default gateway.
   *
   * @return Local IP address string, or an empty string when it cannot be determined.
   */
  ...
  constexpr auto SERVICE_NAME = "Apollo";  ///< mDNS service instance name advertised for GameStream discovery.
  ...
  /**
   * @brief Read the current text content of the system clipboard.
   *
  ...
  /**
   * @brief Replace the system clipboard content with text.
   *
